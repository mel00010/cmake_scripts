...
FetchContent_Declare(p7
  URL      http://baical.net/files/libP7Client_v5.5.zip
  URL_HASH SHA256=27b5b8f0ccfad2aac582dae5b17367ce3071b42f8086ceded04a660dad1d7cb4
)

FetchContent_GetProperties(p7)
if(NOT p7_POPULATED)
  FetchContent_Populate(p7)
  add_subdirectory(${p7_SOURCE_DIR} ${p7_BINARY_DIR})
endif()
...
#  )
#  set_target_properties(P7 PROPERTIES INTERPROCEDURAL_OPTIMIZATION FALSE)
#
#  if(WIN32)
#    target_sources(P7
#      PUBLIC

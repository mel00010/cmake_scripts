...
public:
    ...
    file() = default;
    file(iterator beg, iterator end, std::string filename, std::string path) noexcept : _begin(beg), _end(end), _filename(filename), _path(path) {}
};
...
public:
    ...
    file_data(const char* b, const char* e, std::string f, std::string p) : begin_ptr(b), end_ptr(e), filename(f), path(p) {}
};
...
public:
    ...
    file_or_directory* add_file(std::string name, std::string path, const char* begin, const char* end) & {
        assert(_index.find(name) == _index.end());
        _files.emplace_back(begin, end, name, path);
...
public:
    ...
    file open(const std::string& path) const {
        ...
        return file{dat.begin_ptr, dat.end_ptr, dat.filename, dat.path};
    }
